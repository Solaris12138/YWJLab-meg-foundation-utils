...
from .components.local_global_transformer import LocalGlobalTransformer
from .utils.position_encoding import add_position_encoding

class MSCLGT(nn.Module):
    ...
    def __init__(
        ...
        hidden_dim=256,
        n_heads=16,
        n_transformer_blocks_global=2,
        n_transformer_blocks_local=2,
        kernel_sizes=[3, 6, 9],
        strides=[1, 1, 1],
        paddings=[0, 0, 0],
        ...
        self.transformer_temp = LocalGlobalTransformer(
            n_local_blocks=n_transformer_blocks_local,
            n_global_blocks=n_transformer_blocks_global,
